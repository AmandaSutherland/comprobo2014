...
if("TRUE" STREQUAL "TRUE")
  set(neato_driver_SOURCE_PREFIX /home/amanda-sutherland/catkin_ws/src/comprobo2014/src/neato_robot/neato_driver)
  set(neato_driver_DEVEL_PREFIX /home/amanda-sutherland/catkin_ws/src/comprobo2014/devel)
  ...
  set(neato_driver_INSTALL_PREFIX /home/amanda-sutherland/catkin_ws/src/comprobo2014/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amanda-sutherland/catkin_ws/src/comprobo2014/src/neato_robot/neato_driver/${idir}'.  Ask the maintainer 'Michael Ferguson <ferguson@cs.albany.edu>' to fix it.")
    endif()
